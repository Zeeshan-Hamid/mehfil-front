...
import styles from './VendorChatbot.module.css';
...
const VendorChatbot = () => {
  ...
  const [messages, setMessages] = useState([
    {
      id: 1,
      type: 'bot',
      content: "Hello! I'm your AI assistant here to help you grow your business on Mehfil. I can help you with profile optimization, customer attraction strategies, current trends, and much more. What would you like to know?",
      timestamp: new Date()
    }
  ]);
  ...
  const handleSendMessage = async () => {
    ...
    try {
      ...
      console.log('Chatbot token check:', { 
        hasToken: !!token, 
        tokenLength: token?.length,
        tokenStart: token?.substring(0, 20) + '...'
      });
      
      const response = await fetch('/api/chatbot/vendor-chat', {
        method: 'POST',
        headers: {
      ...
      {isOpen && (
        <div className={styles.chatWindow}>
          ...
          <div className={styles.inputContainer}>
               ...
               placeholder="How may I help you in your business?"
